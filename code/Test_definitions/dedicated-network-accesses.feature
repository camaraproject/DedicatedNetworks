Feature: CAMARA Dedicated Network API, v0.2.0-alpha.1 - Network Accesses API Operations
  ...
  Scenario: List all network accesses
    Given the resource "/dedicated-network-accesses/v0.2alpha1/accesses"
  ...
  Scenario: List network accesses filtered by network ID
    ...
    And the resource "/dedicated-network-accesses/v0.2alpha1/accesses"
  ...
  Scenario: Get details of a specific network access
    ...
    And the resource "/dedicated-network-accesses/v0.2alpha1/accesses/{accessId}"
