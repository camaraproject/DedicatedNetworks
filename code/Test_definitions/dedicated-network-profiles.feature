Feature: CAMARA Dedicated Network API, v0.2.0-alpha.1 - Network Profiles API Operations
  ...
  Scenario: List all available network profiles
    Given the resource "/dedicated-network-profiles/v0.2alpha1/profiles"
  ...
  Scenario: Get details of a specific network profile
    ...
    And the resource "/dedicated-network-profiles/v0.2alpha1/profiles/{profileId}"
