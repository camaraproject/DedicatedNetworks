Feature: CAMARA Dedicated Network API, v0.2.0-alpha.1 - Networks API Operations
  ...
  Scenario: List all dedicated networks
    Given the resource "/dedicated-network/v0.2alpha1/networks"
  ...
  Scenario: Get details of a specific network
    ...
    And the resource "/dedicated-network/v0.2alpha1/networks/{networkId}"
